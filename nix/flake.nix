      ...
      nixosConfigurations =
        let
          keys = [
            ...
            "ssh-rsa  jerry@Arch-X230"
          ];
          system = "x86_64-linux";
        in
        # NixOS LXCs
